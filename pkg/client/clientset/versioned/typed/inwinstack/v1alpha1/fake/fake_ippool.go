...
var ippoolsResource = schema.GroupVersionResource{Group: "inwinstack.com", Version: "v1alpha1", Resource: "ippools"}

var ippoolsKind = schema.GroupVersionKind{Group: "inwinstack.com", Version: "v1alpha1", Kind: "IPPool"}
...
func (c *FakeIPPools) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.IPPool, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(ippoolsResource, name, data, subresources...), &v1alpha1.IPPool{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.IPPool), err
